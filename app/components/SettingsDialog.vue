...
import {
  Bell, Check, Globe, Home, Keyboard, Link, Lock, Menu,
  MessageCircle, Paintbrush, Settings, Video
...
// 🔄 Sincroniza el estado externo con interno
...
<template>
  <Dialog v-model:open="localOpen" class="backdrop-blur-md">
    <DialogContent
